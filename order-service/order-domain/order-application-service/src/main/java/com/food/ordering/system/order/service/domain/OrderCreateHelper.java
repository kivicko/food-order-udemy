...
public class OrderCreateHelper {
    ...
    private Restaurant checkRestaurant(CreateOrderCommand createOrderCommand) {
        ...
        if(restaurantInformation.isEmpty()) {
            log.warn("Could not find restaurant with given Id : {}", restaurant.getId().getValue());
            throw new OrderDomainException("Could not find customer with given Id : " + restaurant.getId().getValue());
        }
    ...
    private void checkCustomer(UUID customerId) {
        ...
        if(customer.isEmpty()) {
            log.warn("Could not find customer with given Id : {}", customerId);
            throw new OrderDomainException("Could not find customer with given Id : " + customerId);
        }
    }
